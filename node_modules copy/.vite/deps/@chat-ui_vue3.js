...
var k = {
  ...
  updated() {
    ...
    t && this.chatElementAdded && (this.scrollToEnd(t), this.chatElementAdded = false);
  },
  watch: {
    onUpdateHook0: {
      handler() {
        document.getElementById("chat-container") && (this.chatElementAdded = true);
      },
      immediate: true
    }
  },
...
function O(t, o, e, c, d, s) {
  return openBlock(), createElementBlock("div", {
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(e.chat, (a, m) => (openBlock(), createElementBlock("div", { key: m }, [
      a.type == "person" ? (openBlock(), createElementBlock("div", I, [
        createBaseVNode("div", {
          class: "div-2",
          style: normalizeStyle({
          ...
          a.timestamp ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "div-3",
            style: normalizeStyle({
          ...
          }, toDisplayString(a.timestamp), 5)) : createCommentVNode("", true),
          createTextVNode(toDisplayString(a.message), 1)
        ], 4)
      ])) : createCommentVNode("", true),
      a.type == "chatbot" ? (openBlock(), createElementBlock("div", Z, [
        createBaseVNode("div", {
          class: "div-4",
          style: normalizeStyle({
...
var T = C(k, [["render", O], ["__scopeId", "data-v-9bed9119"]]);
var S = {
  name: "chat-input",
  props: [
    "onSend",
...
var p = (t) => (pushScopeId("data-v-46284fc5"), t = t(), popScopeId(), t);
var P = ["placeholder", "value"];
var V = ["strokeWidth"];
var B = p(() => createBaseVNode("path", {
...
var F = C(S, [["render", D], ["__scopeId", "data-v-46284fc5"]]);
var z = {
  name: "chat-icon"
};
var A = { style: {
...
function J(t, o, e, c, d, s) {
  const a = resolveComponent("chat-icon");
  return openBlock(), createElementBlock("div", {
    style: normalizeStyle({
      display: "flex",
    ...
    createBaseVNode("div", {
      ...
      createBaseVNode("div", j, [
        ...
        e.offline ? (openBlock(), createElementBlock("div", U, "Offline")) : (openBlock(), createElementBlock("div", X, "Online"))
      ])
    ], 4),
    (openBlock(), createElementBlock("svg", {
      xmlns: "http://www.w3.org/2000/svg",
...
function ee(t, o, e, c, d, s) {
  const a = resolveComponent("chat-icon"), m = resolveComponent("chat-header"), _ = resolveComponent("chat-messages"), M = resolveComponent("chat-input");
...
var ne = C(Q, [["render", ee]]);
export {
  ne as Chat
};
//# sourceMappingURL=@chat-ui_vue3.js.map
